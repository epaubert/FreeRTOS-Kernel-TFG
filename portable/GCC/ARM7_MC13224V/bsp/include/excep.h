 ...
 *			 			3: I=1, F=1	(IRQ deshabilitadas, FIQ deshabilitadas)
 */
void excep_restore_ints (uint32_t if_bits);
 ...
 * 						1: I=1	(IRQ deshabilitadas)
 */
void excep_restore_irq (uint32_t i_bit);
 ...
 * 						1: F=1	(FIQ deshabilitadas)
 */
void excep_restore_fiq (uint32_t f_bit);
